...
public class OmeMetadata extends DashboardMetadata {
	 ...
	 * generated by the constructor from Benjamin's spreadsheet
	 * TSV table of metadata.
	 * 
	 * @param expocode
	 * 		expocode of the cruise
	 * @return
	 * 		the "upload filename" for the generated OME XML file
	 */
	public static String generatedOmeName(String expocode) {
		return expocode + "_OME.xml";
	}
	...
	public OmeMetadata(String[] colNames, String metadataLine, String timestamp) {
		...
		filename = generatedOmeName(expocode);  
