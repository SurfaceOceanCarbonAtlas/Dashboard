...
public class DashboardUtils {
	...
	static {
		...
		STD_HEADER_NAMES.put(DataColumnType.XCO2_ATM_WET_ACTUAL, "xCO2_atm_wet_actual");
		STD_HEADER_NAMES.put(DataColumnType.XCO2_ATM_WET_INTERP, "xCO2_atm_wet_interp");
		STD_HEADER_NAMES.put(DataColumnType.PCO2_ATM_WET_ACTUAL, "pCO2_atm_actual");
		STD_HEADER_NAMES.put(DataColumnType.PCO2_ATM_WET_INTERP, "pCO2_atm_interp");
		STD_HEADER_NAMES.put(DataColumnType.FCO2_ATM_WET_ACTUAL, "fCO2_atm_actual");
		STD_HEADER_NAMES.put(DataColumnType.FCO2_ATM_WET_INTERP, "fCO2_atm_interp");
	...
	static {
		...
		STD_DATA_UNITS.put(DataColumnType.XCO2_ATM_WET_ACTUAL, XCO2_UNITS);
		STD_DATA_UNITS.put(DataColumnType.XCO2_ATM_WET_INTERP, XCO2_UNITS);
