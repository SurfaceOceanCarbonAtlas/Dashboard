...
<div id="generaldescription" class="Section1 section">
	...
	<ul>
		...
		<li class="Section1">Sea Surface Salinity (SSS):
			<ul>
				<li class="Section2"><label>Location and depth of SSS
						sensor:</label> <form:input path="field_SSS_sensor" id="field_SSS_sensor" /></li>
				<li class="Section2"><label>Manufacturer SSS sensor:</label> <form:input
						path="field_SSS_manufacturer" id="field_SSS_manufacturer" /></li>
				<li class="Section2"><label>Model SSS sensor:</label> <form:input
						path="field_SSS_model" id="field_SSS_model" /></li>
				<li class="Section2"><label>Accuracy SSS:</label> <form:input
						path="field_SSS_accuracy" id="field_SSS_accuracy" /></li>
				<li class="Section2"><label>Precision SSS:</label> <form:input
						path="field_SSS_precision" id="field_SSS_precision" /></li>
		...
		<li class="Section1">Atmospheric Pressure (not equilibrator
			pressure)(P<sub>atm</sub>):
			<ul>
				<li class="Section2"><label>Location and height of P<sub>atm</sub>
						sensor:<span class="form-required req-filter1"
						title="This field is required.">*</span>
				</label> <form:input path="field_Patm_sensor" id="field_Patm_sensor" /></li>

				<li class="Section2"><label>Atmospheric pressure has
						been normalized to and reported at sea level<span
				...
				<li class="Section2"><label>Manufacturer P<sub>atm</sub>:<span
						class="form-required req-filter1" title="This field is required.">*</span>
				</label> <form:input path="field_Patm_manufacturer"
						id="field_Patm_manufacturer" /></li>
				<li class="Section2"><label>Model P<sub>atm</sub>:<span
						class="form-required req-filter1" title="This field is required.">*</span>
				</label> <form:input path="field_Patm_model" id="field_Patm_model" /></li>
				<li class="Section2"><label>Accuracy P<sub>atm</sub>
						(specify unit):<span class="form-required req-filter1"
						title="This field is required.">*</span>
				</label> <form:input path="field_Patm_accuracy" id="field_Patm_accuracy" /></li>
				<li class="Section2"><label>Precision P<sub>atm</sub>
						(specify unit):<span class="form-required req-filter1"
						title="This field is required.">*</span>
