...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link href="bootstrap/css/bootstrap.css" rel="stylesheet">
		<link href="bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
			...
			<!--<script type='text/javascript' src='/OME/dwr/interface/Place1.js'></script>-->
...
<body data-spy="scroll" data-target=".bs-docs-sidebar">
	...
	<div class="container">
		<form:form name="UnderwayForm" id="mainform" action="saveForm.htm"
			...
			<div class="row-fluid">
				<c:forEach items="${editor.med.field_conflicts}" begin="1" var="conflicts"
					varStatus="status">
						${conflict}
				</c:forEach>
			</div>
			...
			<div class="row-fluid">
				<div class="span2 bs-docs-sidebar">
					<ul class="nav nav-list bs-docs-sidenav affix-top">
						...
						<li><a href="#datasetlinks"><i class="icon-chevron-right"></i>
								Data Set Links</a></li>
				...
				<div class="span10">
					...
					<input type="hidden" id="VarShown" value="0"> <input
						type="hidden" id="InvShown" value="1"> <input
							type="hidden" id="SensorShown" value="0"> <form:input
									type="hidden" value="" path="field_record_id" /> <form:input
									type="hidden" value="" path="field_filename" /> <form:input type="hidden"
								...
								id="Files" value="0"> <input type="hidden"
									name="MAX_FILE_SIZE" value="20000000"> <form:input
											...
											value="underway" /><%@include file="contact.jsp"%>
					...
					<div class="req-filter1">
						...
						<c:if test="${editor.adminUser =='true'}">
							<input type="submit" class="addfilter1 btn btn-info" name="draft"
								value="Save as Draft" />
						</c:if>
						<input name="submit" class="addfilter1 btn btn-success"
					...
					<div class="req-filter2">
						<input type="submit" class="btn btn-info cancel"
							value="Save Locally" name="savelocally" />
						<c:if test="${editor.adminUser =='true'}">
							<input type="submit" class="btn btn-info addfilter2"
								id="addfilter2" name="draft" value="Save as Draft" />
						</c:if>
						<input name="submit" class="addfilter2 btn btn-success"
							value="Submit" type="submit" />
