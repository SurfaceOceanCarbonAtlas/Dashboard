...
Autocompleter.DWR.prototype = Object.extend(new Autocompleter.Base(),{
	...
	initialize:function(element, update, populator, options, init) {    	
                ...
                for (var i = 0; i < instance.options.array.length &&
                    ...
                    while (foundPos != -1) {
                        if (foundPos == 0 && elem.length != entry.length){
                            ...
                            ret.push("<li><bold>" + elem.substr(0, entry.length) + "</bold>" +
                            ...
                            if (instance.options.fullSearch ||
                                ...
                                partial.push("<li>" + elem.substr(0, foundPos) + "<bold>" +
                                        elem.substr(foundPos, entry.length) + "</bold>" +
