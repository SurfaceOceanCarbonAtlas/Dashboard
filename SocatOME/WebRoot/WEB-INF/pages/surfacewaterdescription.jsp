<div id="surfacewaterdescription" class="section">
	...
	<ul>
		...
		<li class="Section1">CO<sub>2</sub> Sensors:
			<ul>
				<li class="Section2"><label style="width: 450">Measurement
						Method CO<sub>2</sub>(IR, spectrophotometric, CRDS, GC):<span
						class="form-required" title="This field is required.">*</span>
				</label> <form:input path="field_measurement_method"
						id="field_measurement_method" /></li>
				...
				<li class="Section2"><label>Calibration of CO<sub>2</sub>
						calibration gases (document traceability to an internationally
						recognized scale, including frequency of calibration, and location
						of calibrations):<span class="form-required"
						title="This field is required.">*</span><br>
				</label> <form:textarea path="field_calibration" id="field_calibration"
						cols="66" rows="2" /></li>
		...
		<li class="Section1">Temperature at place of equilibration (T<sub>equ</sub>):
			<ul>
				<li class="Section2"><label>Way of
						T<sub>equ</sub> measurement, Location of T<sub>equ</sub> sensor:<span
						class="form-required" title="This field is required.">*</span>
				</label> <form:input path="field_Tequ_location" id="field_Tequ_location" /></li>
				<li class="Section2"><label>Manufacturer
						T<sub>equ</sub> sensor:<span class="form-required"
						title="This field is required.">*</span>
				...
				<li class="Section2"><label>Accuracy
						T<sub>equ</sub>(degrees Celsius):<span class="form-required"
						title="This field is required.">*</span>s
				</label> <form:input path="field_Tequ_accuracy" id="field_Tequ_accuracy" /></li>
				<li class="Section2"><label>Precision
						T<sub>equ</sub>(degrees Celsius):<span class="form-required"
						title="This field is required.">*</span>
				</label> <form:input path="field_Tequ_precision" id="field_Tequ_precision" /></li>
		...
		<li class="Section1">Equilibrator Pressure (P<sub>equ</sub>):
			<ul>
				<li class="Section2"><label>Location
						of P<sub>equ</sub> sensor:<span class="form-required"
						title="This field is required.">*</span>
				</label> <form:input path="field_Pequ_sensor" id="field_Pequ_sensor" /></li>
				<li class="Section2"><label>Manufacturer
						P<sub>equ</sub> sensor:<span class="form-required"
						title="This field is required.">*</span>
				...
				<li class="Section2"><label>Accuracy
						P<sub>equ</sub>:<span class="form-required"
						title="This field is required.">*</span>
				</label> <form:input path="field_Pequ_accuracy" id="field_Pequ_accuracy" /></li>
				<li class="Section2"><label>Precision
						P<sub>equ</sub>:<span class="form-required"
						title="This field is required.">*</span>
				</label> <form:input path="field_Pequ_precision" id="field_Pequ_precision" /></li>
