...
<div id="cruiseinfo" class="Section1 section">
	...
	<ul>
		...
		<li>Other Cruise Info:
			<ul>
				<li class="Section2">Platform Type:<span class="form-required"
					...
					class="select2">
						<option value="Self-propelled surface platform">Self-propelled
							surface platform</option>
						<option value="Ship">Ship</option>
						<option value="Mooring">Mooring</option>
						<option value="Surface Drifter">Surface Drifter</option>
						<option value="Others">Others</option>
				</select> <form:input class="short" id="field_platform_type"
						style="display:none" placeHolder="Describe Others Here"
						path="field_platform_type" />

				</li>


				<li class="Section2">CO<sub>2</sub> Instrument Type <span
					class="form-required" title="This field is required.">*</span>:</br> <select
					type="text" id="select_co2_instr_type" class="select2"
					onchange="filterReq()">
						<option value="Equilibrator-IR or CRDS or GC">Equilibrator-IR
							or CRDS or GC</option>
						<option value="Membrane-IR">Membrane-IR</option>
						<option value="Spectrophotometry">Spectrophotometry</option>
						<option value="Others">Others</option>
				</select> <form:input class="short" id="field_co2_instr_type"
						style="display:none" placeHolder="Describe Others Here"
						path="field_co2_instr_type" />
				</li>
		...
		<form:input path="field_vessel_name" name="Vessel_Name" /></li>

		<li class="Section2"><label for="Vessel_Owner" style="width: 150">Vessel
				Owner: </label>
		<form:input path="field_vessel_owner" name="Vessel_Owner" /></li>

		<li class="Section2"><label for="Cruise_Info">Campaign
				Info/Cruise Info (e.g. SAVE, TTO-NAS, SOIREE, AMT08, Antares,
				EisenEx):</label>
		<form:input path="field_cruise_info" name="Cruise_Info" type="text" /></li>
		...
		<form:input path="field_experiment_name" name="field_experiment_name"
				type="text" /></li>

		<li class="Section2"><label for="End_Date">End Date:</label> <form:input
				path="field_end_date" id="field_end_date" class="short" size="9" />
			<span class="description">(yyyymmdd)</span> <form:input
				path="field_end_date_dup" id="field_end_date_dup" type="hidden" /></li>
