...
/**
 	* A data access object (DAO) providing persistence and search support for UserRoles entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see ornl.database.UserRoles
  * @author MyEclipse Persistence Tools 
 */

public class UserRolesDAO extends BaseHibernateDAO  {
    ...
    public void save(UserRoles transientInstance) {
    ...
    public UserRoles findById( java.lang.Integer id) {
        ...
        try {
            UserRoles instance = (UserRoles) getSession()
                    .get("ornl.database.UserRoles", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(UserRoles instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("ornl.database.UserRoles")
    ...
    public UserRoles merge(UserRoles detachedInstance) {
        ...
        try {
            UserRoles result = (UserRoles) getSession()
