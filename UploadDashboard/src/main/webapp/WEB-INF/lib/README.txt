...
The jar files:
	svnkit-1.9.2.jar
	svnkit-cli-1.9.2.jar
	svnkit-javahl16-1.9.2.jar
	sqljet-1.1.11.jar
...
The jar file mysql-connector-java-5.1.46.jar was obtained from https://dev.mysql.com/downloads/connector/j/
The jar file gson-2.8.2.jar was obtained from http://repo1.maven.org/maven2/com/google/code/gson/gson/
The jar files:
	fop-2.2.jar
