...
public class DashDataType implements Comparable<DashDataType> {
    ...
    /**
     * @return the variable name for this data type;
     * never null or blank
     */
    ...
    /**
     * @return the sorting order for this data type;
    ...
    /**
     * @return the displayed name for this data type;
     * never null or blank
     */
    ...
    /**
     * @return the data class name for this data type
     * (e.g., Character, Double, Integer, String);
    ...
    /**
     * @return standard name of a variable of this type;
     * never null but may be {@link DashboardUtils#STRING_MISSING_VALUE}
     */
    ...
    /**
     * @return category name of a variable of this type;
     * never null but may be {@link DashboardUtils#STRING_MISSING_VALUE}
     */
    ...
    /**
     * @return a copy of the units associated with this data type;
    ...
    /**
     * @return a DataColumnType constructed from the values in this DashDataType.
    ...
    /**
     * @return if this is a WOCE flag type
     */
     ...
     * @return if this type is a WOCE comment for the given WOCE flag type
     * @throws IllegalArgumentException
     ...
     * @return the newly created DashDataType
     * @throws IllegalArgumentException
