...
public class DataColumnType implements Comparable<DataColumnType>, Serializable, IsSerializable {
    ...
    /**
     * @return the data class name for this data column type
     * (e.g., Character, Double, Integer, String);
     * never null but may be {@link DashboardUtils#STRING_MISSING_VALUE}
     */
    ...
    /**
     * @return the selected missing value, as a string.
    ...
    /**
     * @return a deep of this data column type instance in which copies are
        ...
        if ( woceType != null ) {
            if ( !woceType.isWoceType() )
                throw new IllegalArgumentException(
                        "Argument to isWoceCommentFor is not a WOCE flag type: " + woceType.varName);
