...
public class IntDashDataType extends DashDataType<Integer> {
     ...
     */
    public IntDashDataType(String varName, Double sortOrder, String displayName, String description,
     ...
     *         for those values that are not null, is violated
     */
    public IntDashDataType(DataColumnType dtype, String standardName, String categoryName, String fileStdUnit,
    ...
    @Override
    public ValueConverter<Integer> getStandardizer(String inputUnit, String missingValue, StdUserDataArray stdArray)
