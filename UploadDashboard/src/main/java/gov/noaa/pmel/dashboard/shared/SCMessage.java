...
public class SCMessage implements Serializable, IsSerializable {
    ...
    /**
     * @return the input data column number;
     * or -1 if ambiguous
     */
    ...
    /**
     * @return the input data column name;
    ...
    /**
     * @return the sanity checker general explanation of the issue;
    ...
    /**
     * @return the sanity checker detailed explanation of the issue;
     * never null, but may be {@link DashboardUtils#STRING_MISSING_VALUE}
     */
