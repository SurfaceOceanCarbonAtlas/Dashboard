...
public class DashboardUtils {
    ...
    public static final DataColumnType GEOPOSITION = new DataColumnType("geoposition",
                                                                        -1.0, "(geoposition)", null, null, null, null,
                                                                        NO_UNITS);
    ...
    public static final DataColumnType EXPOCODE = new DataColumnType("expocode",
                                                                     100.0, "expocode", STRING_DATA_CLASS_NAME,
                                                                     "expocode", null,
    ...
    public static final DataColumnType TIMESTAMP = new DataColumnType("date_time",
                                                                      505.0, "date time", STRING_DATA_CLASS_NAME,
                                                                      "date and time", null,
    ...
    public static final DataColumnType DAY_OF_YEAR = new DataColumnType("day_of_year",
                                                                        514.0, "day of year", DOUBLE_DATA_CLASS_NAME,
    ...
    public static final DataColumnType SECOND_OF_DAY = new DataColumnType("sec_of_day",
                                                                          515.0, "sec of day", DOUBLE_DATA_CLASS_NAME,
                                                                          "second of day", "second_of_day",
                                                                          TIME_CATEGORY, NO_UNITS);
     ...
     * @return encrypted password, or an empty string if an error occurs
     */
     ...
     * @return a byte array represented arrayStr
     ...
     * @return the decoded ArrayList of Integers; never null but may be empty
     * @throws NumberFormatException
     *         if arrayStr does not start with '[', does not end with ']',
     ...
     * @return the decoded TreeSet of WoceType's; never null, but may
