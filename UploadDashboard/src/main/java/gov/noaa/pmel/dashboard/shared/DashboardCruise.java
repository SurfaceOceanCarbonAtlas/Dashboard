...
public class DashboardCruise implements Serializable, IsSerializable {
    ...
    /**
     * @return if the cruise is selected
     */
    ...
    /**
     * @return the owner for this cruise;
     * never null but may be {@link DashboardUtils#STRING_MISSING_VALUE}
     */
    ...
    /**
     * @return the CDIAC submission date;
     * never null but may be {@link DashboardUtils#STRING_MISSING_VALUE}
     */
    ...
    /**
     * @return the DOI of the SOCAT-enhanced data document;
     * never null but may be {@link DashboardUtils#STRING_MISSING_VALUE}
     */
    ...
    /**
     * @return the total number of data measurements (data rows)
     * for the cruise
     */
    ...
    /**
     * @return the list of data column types for this cruise; may be empty
    ...
    /**
     * @return the set of WOCE-3 (questionable) flags generated by the
    ...
    /**
     * @return the set of WOCE-4 (bad) flags generated by the
     * automated data checker; may be empty but never null.
     * The actual set in this object is returned.
     */
    ...
    /**
     * @return The set of user-provided WOCE-3 (questionable) flags.
     * The actual set in this object is returned.
     */
    ...
    /**
     * @return The set of user-provided WOCE-4 (bad) flags.
     * The actual set in this object is returned.
     */
