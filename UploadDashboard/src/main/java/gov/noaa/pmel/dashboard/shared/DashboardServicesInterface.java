...
public interface DashboardServicesInterface extends RemoteService {
     ...
     * to those provided.  This triggers the automated data checker
     ...
     * @return the updated dataset with (abbreviated) data after
     *         processing through the automated data checker
     * @throws IllegalArgumentException
     *         if authentication fails, if the dataset ID is invalid,
     *         if the dataset does not exist, or if there are
     ...
     * @return list of data messages for the dataset; never null, 
     * but may be empty if the automated data checker did not generate any data messages.
     * @throws IllegalArgumentException
     *         if the dataset ID is invalid, or
     *         if the automated data checker has never been run on this cruise.
     */
