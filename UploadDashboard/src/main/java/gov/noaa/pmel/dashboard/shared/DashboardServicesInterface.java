...
public interface DashboardServicesInterface extends RemoteService {
     ...
     *
     * @return the list of cruises for the current user
     ...
     * @return current cruise data column specifications and
     ...
     */
    DashboardCruiseTypes getCruiseDataColumnSpecs(String username,
     ...
     * @return rows of data for a cruise.
     * @throws IllegalArgumentException
     *         if authentication fails, if expocode is invalid,
     *         if the cruise does not exist, or if there are
     ...
     * @return the updated cruise with (abbreviated) data after
     ...
     * @return list of data messages for the cruise;
     ...
     * @returns the absolute path to the OME.xml file for activeExpocode
     */
