...
public abstract class DashDataType<T extends Comparable<T>> implements Comparable<DashDataType<?>> {
    ...
    /**
     * @return the simple class name of the data that this data column type provides.
     */
    ...
    /**
     * @return the variable name for this data type; never null or blank
     */
    ...
    /**
     * @return the sorting order for this data type; never null, NaN, or infinite
     */
    ...
    /**
     * @return the displayed name for this data type; never null or blank
     */
    ...
    /**
     * @return a new DataColumnType constructed from the values in this DashDataType.
     */
