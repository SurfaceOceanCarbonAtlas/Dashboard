...
public class CruiseFileHandler extends VersionedFileHandler {
     ...
     * @return the cruise information file associated with the cruise
     * @throws IllegalArgumentException
     ...
     * @param expocode
     *         expocode of the cruise
     * @return the cruise data file associated with the cruise
     * @throws IllegalArgumentException
     *         if the cruise expocode is invalid
     */
     ...
     * @return list of expocodes of existing cruises that match
     ...
     * @return true if the cruise information file exists
     * @throws IllegalArgumentException
     ...
     * @param expocode
     *         expcode of the cruise to check
     * @return true if the cruise data file exists
     * @throws IllegalArgumentException
     *         if expocode is an invalid cruise expocode
     */
     ...
     * @return new DashboardCruise assigned from the information file,
    ...
    public DashboardCruiseWithData getCruiseDataFromFiles(String expocode,
                                                          int firstDataRow, int numDataRows)
            throws IllegalArgumentException {
     ...
     * @param cruiseData
     *         cruise to use
     * @return partial contents of the cruise file
     */
     ...
     * @return the updated cruise information, or
     ...
     * @return the cruise being overwritten or deleted; never null
     * @throws IllegalArgumentException
     *         if the expocode is invalid,
     ...
     * @return true if the status was updated (needed to be updated);
     * otherwise false
     * @throws IllegalArgumentException
     *         if the expocode is invalid,
     ...
     * @return the decoded ArrayList of HashSets of Integers; never null,
