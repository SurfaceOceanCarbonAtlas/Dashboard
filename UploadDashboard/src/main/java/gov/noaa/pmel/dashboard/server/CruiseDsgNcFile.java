...
public class CruiseDsgNcFile extends File {
     ...
     * @param metadataTypes
     *         known data types
     * @return names of the metadata fields not assigned from this
     ...
     * reference from the contents of this netCDF DSG file.
     *
     * @return names of the data fields not assigned from this
     * netCDF file (will have its default/missing value)
     * @throws IOException
     *         if there are problems opening or reading from the netCDF file
     * @throws IllegalArgumentException
            ...
            for (DashDataType dtype : knownTypes.getKnownTypesSet()) {
                ...
                if ( var.getShape(0) != numData )
                    throw new IllegalArgumentException("Number of values for '" + varName +
                                                               "' (" + Integer
                            .toString(var.getShape(0)) + ") does not match " +
                                                               "the number of values for 'time' (" + Integer
                            .toString(numData) + ")");
                String dataClassName = dtype.getDataClassName();
    ...
    /**
     * @return the internal data list reference; may be null
     */
    ...
    /**
     * @return the QC flag contained in this DSG file
     * @throws IllegalArgumentException
     *         if this DSG file is not valid
     * @throws IOException
     ...
     * @param woceEvent
     *         WOCE flags to set
     * @return list of data mismatch messages; never null but may be empty
     * @throws IllegalArgumentException
     ...
     * @return list of the WOCEEvent data locations not found
