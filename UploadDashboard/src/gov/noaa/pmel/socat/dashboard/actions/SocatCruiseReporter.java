...
public class SocatCruiseReporter {
	...
	private static final String[] SINGLE_CRUISE_DATA_REPORT_EXPLANATIONS = {
		...
		"GVCO2: atmospheric xCO2 in micromole per mole interpolated from GlobalView-CO2, 2013 ",
		"    1979-01-01 to 2013-01-01 data (see: http://www.esrl.noaa.gov/gmd/ccgg/globalview/index.html)",
