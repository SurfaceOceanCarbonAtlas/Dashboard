...
public class CruiseModifier {
	...
	public boolean restoreWoceFlags(String expocode) 
		...
		for ( WoceEvent woceEvent : databaseHandler.getWoceEvents(expocode, false) ) {
			...
			if ( woceEvent.getUsername().equals(DashboardEvent.SANITY_CHECKER_USERNAME) )
				continue;
			// Find "old" WOCE events and check if it should be restored
			Character woceFlag = woceEvent.getFlag();
			if ( woceFlag.equals(WoceEvent.OLD_WOCE_BAD) ||
				 woceFlag.equals(WoceEvent.OLD_WOCE_QUESTIONABLE) ||
				 woceFlag.equals(WoceEvent.OLD_WOCE_NOT_CHECKED) ||
				 woceFlag.equals(WoceEvent.OLD_WOCE_GOOD) ||
				 woceFlag.equals(WoceEvent.OLD_WOCE_NO_DATA) ) {
			...
			else if ( woceFlag.equals(WoceEvent.WOCE_BAD) ||
					  woceFlag.equals(WoceEvent.WOCE_QUESTIONABLE) ||
					  woceFlag.equals(WoceEvent.WOCE_NOT_CHECKED) ||
					  woceFlag.equals(WoceEvent.WOCE_GOOD) ||
					  woceFlag.equals(WoceEvent.WOCE_NO_DATA) ) {
		...
		for ( WoceEvent woceEvent : databaseHandler.getWoceEvents(expocode, false) ) {
			...
			if ( woceFlag.equals(WoceEvent.OLD_WOCE_BAD) ||
				...
				if ( ! newLocations.isEmpty() ) {
					Character newFlag;
					if ( woceFlag.equals(WoceEvent.OLD_WOCE_GOOD) ) {
						newFlag = WoceEvent.WOCE_GOOD;
					}
					else if ( woceFlag.equals(WoceEvent.OLD_WOCE_NOT_CHECKED) ) {
						newFlag = WoceEvent.WOCE_NOT_CHECKED;
					}
					else if ( woceFlag.equals(WoceEvent.OLD_WOCE_QUESTIONABLE) ) {
						newFlag = WoceEvent.WOCE_QUESTIONABLE;
					}
					else if ( woceFlag.equals(WoceEvent.OLD_WOCE_BAD) ) {
						newFlag = WoceEvent.WOCE_BAD;
					}
					else if ( woceFlag.equals(WoceEvent.OLD_WOCE_NO_DATA) ) {
	...
	public ArrayList<String> woceDuplicateDatapoints(String expocode)
		...
		if ( ! dupDatInf.isEmpty() ) {
			...
			woceEvent.setFlag(WoceEvent.WOCE_BAD);
