...
public class DashboardUtils {
	...
	static {
		...
		STD_HEADER_NAMES.put(DataColumnType.WOCE_GEOPOSITION, "WOCE_geoposition");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_SAMPLE_DEPTH, "WOCE_sample_depth");
		...
		STD_HEADER_NAMES.put(DataColumnType.WOCE_PCO2_WATER_TEQU, "WOCE_pCO2_water_Tequ");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_PCO2_WATER_SST, "WOCE_pCO2_water_SST");
		...
		STD_HEADER_NAMES.put(DataColumnType.WOCE_RELATIVE_HUMIDITY, "WOCE_rel_humidity");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_SPECIFIC_HUMIDITY, "WOCE_spc_humidity");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_SHIP_SPEED, "WOCE_ship_speed");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_SHIP_DIRECTION, "WOCE_ship_dir");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_WIND_SPEED_TRUE, "WOCE_wind_speed_true");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_WIND_SPEED_RELATIVE, "WOCE_wind_speed_rel");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_WIND_DIRECTION_TRUE, "WOCE_wind_dir_true");
		STD_HEADER_NAMES.put(DataColumnType.WOCE_WIND_DIRECTION_RELATIVE, "WOCE_wind_dir_rel");
	...
	static {
		...
		STD_DATA_UNITS.put(DataColumnType.WOCE_GEOPOSITION, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_SAMPLE_DEPTH, NO_UNITS);
		...
		STD_DATA_UNITS.put(DataColumnType.WOCE_XCO2_WATER_TEQU, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_XCO2_WATER_SST, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_PCO2_WATER_TEQU, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_PCO2_WATER_SST, NO_UNITS);
		...
		STD_DATA_UNITS.put(DataColumnType.WOCE_RELATIVE_HUMIDITY, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_SPECIFIC_HUMIDITY, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_SHIP_SPEED, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_SHIP_DIRECTION, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_WIND_SPEED_TRUE, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_WIND_SPEED_RELATIVE, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_WIND_DIRECTION_TRUE, NO_UNITS);
		STD_DATA_UNITS.put(DataColumnType.WOCE_WIND_DIRECTION_RELATIVE, NO_UNITS);
