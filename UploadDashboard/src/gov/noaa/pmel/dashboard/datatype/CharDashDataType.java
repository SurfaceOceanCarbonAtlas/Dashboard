...
/**
 * Data column types that provides Character data.
 * 
 * @author Karl Smith
 */
public class CharDashDataType extends DashDataType<Character> {
	 ...
	 */
	public CharDashDataType(String varName, Double sortOrder, String displayName, 
	 ...
	 * 		for those values that are not null, is violated
	 */
	public CharDashDataType(DataColumnType dtype, String standardName, String categoryName, 
