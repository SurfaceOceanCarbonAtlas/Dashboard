...
public class DashboardConfigStore {
	...
	private DashboardConfigStore(boolean startMonitors) throws IOException {
		...
		knownUserDataTypes = new KnownDataTypes().addStandardTypesForUsers();
		...
		knownMetadataTypes = new KnownDataTypes().addStandardTypesForMetadataFiles();
		// TODO: read additional types from Properties files
		{
			Properties typeProps = new Properties();
		...
		knownDataTypes = new KnownDataTypes().addStandardTypesForDataFiles();
		// TODO: read additional types from Properties files
		{
			Properties typeProps = new Properties();
			typeProps.setProperty(SocatCruiseData.SALINITY.getVarName(), SocatCruiseData.SALINITY.toPropertyValue());
