...
public class CruiseDsgNcFileTest {
    ...
    public static final DashDataType XH2O_EQU = new DashDataType("xH2O_equi",
                                                                 660.0, "xH2O_equi",
                                                                 DashboardUtils.DOUBLE_DATA_CLASS_NAME,
                                                                 "xH2O in equil air sample",
                                                                 "mole_fraction_of_water_in_air",
    ...
    public static final DashDataType RELATIVE_HUMIDITY = new DashDataType("relative_humidity",
                                                                          ...
                                                                          DashboardUtils.WATER_VAPOR_CATEGORY,
    ...
    public static final DashDataType WIND_DIRECTION_TRUE = new DashDataType("wind_dir_true",
                                                                            ...
                                                                            "true wind direction",
                                                                            "wind_from_direction",
                                                                            DashboardUtils.WIND_CATEGORY,
                                                                            DIRECTION_UNITS);

    public static final DashDataType WIND_SPEED_RELATIVE = new DashDataType("wind_speed_rel",
                                                                            674.0, "rel wind speed",
                                                                            DashboardUtils.DOUBLE_DATA_CLASS_NAME,
                                                                            "relative wind speed",
                                                                            "wind_speed", DashboardUtils.WIND_CATEGORY,
                                                                            WIND_SPEED_UNITS);
    ...
    public static final DashDataType CALC_SPEED = new DashDataType("calc_speed",
                                                                   704.0, "calc ship speed",
                                                                   DashboardUtils.DOUBLE_DATA_CLASS_NAME,
                                                                   "calculated ship speed", "platform_speed_wrt_ground",
                                                                   DashboardUtils.PLATFORM_CATEGORY, SHIP_SPEED_UNITS);

    public static final DashDataType FCO2_FROM_XCO2_TEQU = new DashDataType(
            ...
            "fCO2 from xCO2_water_equi_temp_dry_ppm, Pressure_equi, sal",
    ...
    public static final DashDataType FCO2_FROM_XCO2_SST = new DashDataType("fCO2_insitu_from_xCO2_water_sst_dry_ppm",
                                                                           721.0,
                                                                           "fCO2 from xCO2_water_SST_dry, Pequ, sal",
                                                                           DashboardUtils.DOUBLE_DATA_CLASS_NAME,
                                                                           "fCO2 from xCO2_water_sst_dry_ppm, Pressure_equi, sal",
                                                                           "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
                                                                           DashboardUtils.CO2_CATEGORY,
                                                                           SocatTypes.FCO2_UNITS);
    ...
    public static final DashDataType FCO2_FROM_PCO2_TEQU = new DashDataType("fCO2_from_pCO2_water_water_equi_temp",
                                                                            722.0,
                                                                            "fCO2 from pCO2_water_Tequ_wet, Pequ, sal",
                                                                            DashboardUtils.DOUBLE_DATA_CLASS_NAME,
                                                                            "fCO2 from pCO2_water_equi_temp, Pressure_equi, sal",
                                                                            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
                                                                            DashboardUtils.CO2_CATEGORY,
                                                                            SocatTypes.FCO2_UNITS);
    ...
    public static final DashDataType FCO2_FROM_PCO2_SST = new DashDataType("fCO2_from_pCO2_water_sst_100humidity_uatm",
                                                                           723.0,
                                                                           "fCO2 from pCO2_water_SST_wet, Pequ, sal",
                                                                           DashboardUtils.DOUBLE_DATA_CLASS_NAME,
                                                                           "fCO2 from pCO2_water_sst_100humidity_uatm, Pressure_equi, sal",
                                                                           "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
                                                                           DashboardUtils.CO2_CATEGORY,
                                                                           SocatTypes.FCO2_UNITS);
    ...
    public static final DashDataType FCO2_FROM_FCO2_TEQU = new DashDataType("fCO2_insitu_from_fCO2_water_equi_uatm",
                                                                            724.0,
                                                                            "fCO2 from fCO2_water_Tequ_wet, Pequ, sal",
                                                                            DashboardUtils.DOUBLE_DATA_CLASS_NAME,
                                                                            "fCO2 from fCO2_water_equi_temp, Pressure_equi, sal",
                                                                            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
                                                                            DashboardUtils.CO2_CATEGORY,
                                                                            SocatTypes.FCO2_UNITS);

    public static final DashDataType FCO2_FROM_FCO2_SST = new DashDataType(
            ...
            "fCO2 from fCO2_water_sst_100humidity_uatm, Pressure_equi, sal",
            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
            DashboardUtils.CO2_CATEGORY, SocatTypes.FCO2_UNITS);

    public static final DashDataType FCO2_FROM_PCO2_TEQU_NCEP = new DashDataType(
    ...
    public static final DashDataType FCO2_FROM_PCO2_SST_NCEP = new DashDataType(
            ...
            "fCO2 from pCO2_water_sst_100humidity_uatm, NCEP SLP, sal",
            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
            DashboardUtils.CO2_CATEGORY, SocatTypes.FCO2_UNITS);

    public static final DashDataType FCO2_FROM_XCO2_TEQU_WOA = new DashDataType(
            ...
            "fCO2 from xCO2_water_equi_temp_dry_ppm, Pressure_equi, WOA SSS",
            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
            DashboardUtils.CO2_CATEGORY, SocatTypes.FCO2_UNITS);

    public static final DashDataType FCO2_FROM_XCO2_SST_WOA = new DashDataType(
            ...
            "fCO2 from xCO2_water_sst_dry_ppm, Pressure_equi, WOA SSS",
            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
            DashboardUtils.CO2_CATEGORY, SocatTypes.FCO2_UNITS);

    public static final DashDataType FCO2_FROM_XCO2_TEQU_NCEP = new DashDataType(
            ...
            "fCO2 from xCO2_water_equi_temp_dry_ppm, NCEP SLP, sal",
            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
            DashboardUtils.CO2_CATEGORY, SocatTypes.FCO2_UNITS);

    public static final DashDataType FCO2_FROM_XCO2_SST_NCEP = new DashDataType(
            ...
            "fCO2 from xCO2_water_sst_dry_ppm, NCEP SLP, sal",
            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
            DashboardUtils.CO2_CATEGORY, SocatTypes.FCO2_UNITS);

    public static final DashDataType FOC2_FROM_XCO2_TEQU_NCEP_WOA = new DashDataType(
            ...
            "fCO2 from xCO2_water_equi_temp_dry_ppm, NCEP SLP, WOA SSS",
            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
            DashboardUtils.CO2_CATEGORY, SocatTypes.FCO2_UNITS);

    public static final DashDataType FCO2_FROM_XCO2_SST_NCEP_WOA = new DashDataType(
            ...
            "fCO2 from xCO2_water_sst_dry_ppm, NCEP SLP, WOA SSS",
            "surface_partial_pressure_of_carbon_dioxide_in_sea_water",
            DashboardUtils.CO2_CATEGORY, SocatTypes.FCO2_UNITS);
    ...
    static {
        ...
        typeProps.setProperty(FOC2_FROM_XCO2_TEQU_NCEP_WOA.getVarName(),
                              FOC2_FROM_XCO2_TEQU_NCEP_WOA.toPropertyValue());
