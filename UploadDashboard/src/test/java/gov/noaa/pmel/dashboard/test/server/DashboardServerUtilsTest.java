...
public class DashboardServerUtilsTest {
    ...
    /**
     * Test method for {@link gov.noaa.pmel.dashboard.server.DashboardServerUtils#checkExpocode(java.lang.String)}.
     */
    @Test
    public void testCheckExpocode() {
        assertEquals("ABCD20120506", DashboardServerUtils.checkExpocode("abcd20120506"));
        assertEquals("ABCDE20130708", DashboardServerUtils.checkExpocode("ABcde20130708"));
        assertEquals("ABCDE20140809-2", DashboardServerUtils.checkExpocode("abcDE20140809-2"));
        boolean caught = false;
        try {
            DashboardServerUtils.checkExpocode("ABC20140809");
        } catch (IllegalArgumentException ex) {
            caught = true;
        }
        caught = false;
        try {
            DashboardServerUtils.checkExpocode("ABCDEFGH20140809");
        } catch (IllegalArgumentException ex) {
            caught = true;
        }
        caught = false;
        try {
            DashboardServerUtils.checkExpocode("ABCD_20140809");
        } catch (IllegalArgumentException ex) {
            caught = true;
        }
        assertTrue(caught);
    ...
    /**
     * Test method for {@link gov.noaa.pmel.dashboard.server.DashboardServerUtils#isLikeNODCCode(java.lang.String)}.
     */
    @Test
    public void testIsLikeNODCCode() {
        assertTrue(DashboardServerUtils.isLikeNODCCode("ABCD"));
        assertTrue(DashboardServerUtils.isLikeNODCCode("3164"));
        assertFalse(DashboardServerUtils.isLikeNODCCode("ABCDE"));
        assertFalse(DashboardServerUtils.isLikeNODCCode("AB_2"));
    }

    /**
     * Test method for {@link gov.noaa.pmel.dashboard.server.DashboardServerUtils#guessPlatformType(java.lang.String, java.lang.String)}.
     */
    @Test
