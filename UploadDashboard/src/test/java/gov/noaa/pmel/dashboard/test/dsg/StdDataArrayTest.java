...
public class StdDataArrayTest {
    ...
    private static final ArrayList<DataColumnType> DATA_COLUMN_TYPES = new ArrayList<DataColumnType>(
            Arrays.asList(
    ...
    private static final ArrayList<ArrayList<String>> DATA_VALUE_STRINGS = new ArrayList<ArrayList<String>>(
            Arrays.asList(
